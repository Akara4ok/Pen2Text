...
from word_seg_preprocessing import WordSegPreprocessor
...
preprocessor = WordSegPreprocessor(batch_size=settings.BATCH_SIZE_SEG, img_size=(512, 512))
...
checkpoint_dir = "./Models/LineSeg/Checkpoints/" + model_name + "/"
...
tf_path = "./Models/LineSeg/Models/" + model_name + "/tf"
fullModelSave = ModelCheckpoint(filepath=tf_path, 
                             monitor='val_loss', 
                             verbose=1,
                             save_best_only=True,
                             mode='auto')
onnx_path = "./Models/LineSeg/Models/" + model_name + "/onnx/model.onnx"
convert = ConvertCallback(tf_path, onnx_path)

log_dir = "./Models/LineSeg/Logs/" + model_name + "/"
