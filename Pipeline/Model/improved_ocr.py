...
CNN:
7 cnn layers. All layers may have three operations:
    1. CNN layer with filter size 3 x 3 or 2 x 2 and activation as RelU
...
class ImprovedPen2Text(tf.keras.Model):
    ...
    def __init__(self, char_list: list):
        ...
        self.conv_7=tf.keras.layers.Conv2D(512, (2, 2), activation = 'relu')
        ...
        self.blstm_1 = tf.keras.layers.Bidirectional(
            tf.keras.layers.LSTM(num_units, return_sequences=True, dropout=0.2))
